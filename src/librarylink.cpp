...
EXTERN_C DLLEXPORT int wll_cudadpeak(WolframLibraryData libdata, mint argc, MArgument* args, MArgument res)
{
    ...
    std::vector<float> likelihood = cudadpeak_batch(dp52ratio, bgratio, values, probbg, peakgrid);
